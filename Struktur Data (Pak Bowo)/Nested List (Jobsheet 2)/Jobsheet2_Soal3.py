...
for i in range(jml_baris1) :
    a.append([int(s) for s in input("Masukkan elemen array ke-1 baris ke-"+str(i+1)+" (pisahkan dengan spasi): ").split()])

print()

for i in range(jml_baris2) :
    b.append([int(s) for s in input("Masukkan elemen array ke-2 baris ke-"+str(i+1)+" (pisahkan dengan spasi): ").split()])
